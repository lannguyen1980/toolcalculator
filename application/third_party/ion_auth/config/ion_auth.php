...
$config['tables']['cal_thucan']          = 'cal_thucan';
$config['tables']['cal_chedoan']          = 'cal_chedoan';
$config['tables']['cal_chedoanchitiet']          = 'cal_chedoanchitiet';
$config['tables']['cal_cuongdo']          = 'cal_cuongdo';
$config['tables']['cal_gioan']          = 'cal_gioan';
...
/*
 | Users table column and cal_chedoan table column you want to join WITH.
 |
 | Joins from cal_cuongdo.iIDCheDoAn
 */
$config['join']['cal_cuongdo']  = 'iIDCuongDo';

/*
 | Users table column and cal_chedoanchitiet table column you want to join WITH.
 |
 | Joins from cal_chedoan.iIDCheDoAn
 | Joins from cal_thucan.iIDThucAn
 | Joins from cal_gioan.iIDGioAn
 */
$config['join']['cal_chedoan']  = 'iIDCheDoAn';
$config['join']['cal_thucan'] = 'iIDThucAn';
$config['join']['cal_gioan'] = 'iIDGioAn';
