    ...
    **/
    public function user_id()
    {
        ...
        if ($session)
        {
            ...
            {
                // Get users ID
                $user = (new FacebookRequest($session, 'GET', '/me?fields=email,first_name,last_name,gender,name,birthday,location,picture'))
                    ->execute()
                    ->getGraphObject()
                    ->asArray();
    ...
    **/
    public function user()
    {
        ...
        if ($session)
        {
            ...
            {
                // Get user details
                $user = (new FacebookRequest($session, 'GET', '/me?fields=email,first_name,last_name,gender,name,birthday,location,locale,cover,picture'))
                    ->execute()
                    ->getGraphObject()
                    ->asArray();
