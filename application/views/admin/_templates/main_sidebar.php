...
<?php endif; ?>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?=active_link_controller('toolcals')?>">
                            <a href="<?php echo site_url('admin/toolcals'); ?>">
                                <i class="fa fa-calculator"></i> <span><?php echo lang('menu_toolcals'); ?></span>
                            </a>
                        </li>

                        <li class="header text-uppercase">Danh mục</li>
                        <li class="<?=active_link_controller('foods')?>">
                            <a href="<?php echo site_url('admin/foods'); ?>">
                                <i class="fa fa-cutlery"></i> <span><?php echo lang('menu_foods'); ?></span>
                            </a>
                        </li>
