            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table id="tableLstThucAn" class="table table-striped table-hover">
                        ...
                        <tbody>
<?php foreach ($lstFoods as $values):?>
                            <tr id="<?php echo $values->iIDThucAn;  ?>">
                                <td class="vcenter"><input type="checkbox" name="ThucAn[]" id="chk_<?php echo $values->iIDThucAn; ?>" value="1" /></td>
                                <td style="display: none"><?php echo $values->iIDThucAn; ?></td>
                                ...
                                <td class="col-number"><?php echo round($values->fCalori * 100) / 100; ?></td>
                                <td class="col-number"><?php echo round($values->fDam * 100) / 100; ?></td>
                                <td class="col-number"><?php echo round($values->fBeo * 100) / 100; ?></td>
                                <td class="col-number"><?php echo round($values->fBotOrDuong * 100) / 100; ?></td>
                                <td class="col-number"><?php echo round($values->fXo * 100) / 100; ?></td>
                            </tr>
<?php endforeach;?>
                        </tbody>
                    </table>
