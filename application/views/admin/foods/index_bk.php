                             ...
                             <div class="box">
                                ...
                                <div class="box-body" style="max-height: 400px; overflow-y: scroll;">
                                    <table id="tableLstThucAn" class="table table-striped table-hover">
                                        ...
                                        <tbody>
<?php foreach ($foods as $values):?>
                                            <tr>
                                                <td><?php echo htmlspecialchars($values->sTenThucAn, ENT_QUOTES, 'UTF-8'); ?></td>
                                                <td><?php echo htmlspecialchars($values->sSLplusDVT, ENT_QUOTES, 'UTF-8'); ?></td>
                                                <td class="float-right"><?php echo round($values->fCalori * 100) / 100; ?></td>
                                                <td class="float-right"><?php echo round($values->fDam * 100) / 100; ?></td>
                                                <td class="float-right"><?php echo round($values->fBeo * 100) / 100; ?></td>
                                                <td class="float-right"><?php echo round($values->fBotOrDuong * 100) / 100; ?></td>
                                                <td class="float-right"><?php echo round($values->fXo * 100) / 100; ?></td>
                                                <!-- <td><?php echo htmlspecialchars($values->sNote, ENT_QUOTES, 'UTF-8'); ?></td> -->
                                                <td><?php echo anchor("admin/foods/edit/".$values->iIDThucAn, lang('actions_edit')); ?></td>
                                                <!-- <td><?php echo anchor("admin/foods/delete/".$values->iIDThucAn, lang('actions_delete')); ?></td> -->
                                                <td data-id="<?php echo $values->iIDThucAn; ?>"><a class="delete-me" href="#">Delete</a></td>
                                            </tr>
<?php endforeach;?>
                                        </tbody>
                                    </table>
