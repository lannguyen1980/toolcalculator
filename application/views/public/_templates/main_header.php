...
?>
            <header class="main-header">
                <a href="<?php echo site_url('home'); ?>" class="logo">
                    ...
                    <span class="logo-lg">TMV <b><?php echo $title_lg; ?> </b></span>
                    <!-- <span class="logo-lg"><img src="<?php echo base_url(); ?>assets/toolcals/images/logo-lg.jpg"></span> -->
                </a>
...
<?php if ($admin_prefs['user_menu'] == TRUE): ?>
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <?php if(!isset($_SESSION['email']) || empty($_SESSION['profile_pic'])){ ?>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="<?php echo site_url('user_authentication/profile/'); ?>" class="btn btn-default btn-flat"><?php echo lang('header_profile'); ?></a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="<?php echo site_url('user_authentication/logout/'); ?>" class="btn btn-default btn-flat"><?php echo lang('header_sign_out'); ?></a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
