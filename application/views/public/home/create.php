                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <h4 class="panel-title">
                                                    <!--<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion">
                                                       <button type="button" id="showOrHideInfo" class="btn btn-info" >XEM THÔNG TIN</button>
                                                    </a>-->
                                                    <?php echo form_button(array('type' => 'submit', 'class' => 'btn btn-primary btn-flat', 'content' => 'XEM THÔNG TIN')); ?>
                                                </h4>
                                                </div>
...
<script>
    ...
    $(document).ready(function(){
        $("#showOrHideInfo").click(function(){
            swal("", "Vui lòng click Submit trước khi xem thông tin!", "warning");
        });
