                        ...
                        <div class="col-md-12">
                             <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><?php echo lang('toolcals_edit_toolcal'); ?></h3>
                                    <?php 
                                        // var_dump($lstCuongDo);
                                        // var_dump("<br />");
                                        // var_dump($iSoBuaAnNgay);
                                        // var_dump("<br />");
                                        // var_dump(json_decode(json_encode($toolcaldetails), True));
                                     ?>
                                </div>
                                <div class="box-body">
                                    <?php echo $message;?>

                                    <?php echo form_open(current_url(), array('class' => 'form-horizontal', 'iIDCheDoAn' => 'form-edit_toolcal')); ?>
                                        <div class="panel panel-default col-md-6">
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <?php echo form_dropdown('iGioTinh',$iGioTinh , $toolcal->iGioTinh,'id="iGioTinh" name="iGioTinh" class="form-control" ');?>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <?php echo form_dropdown('iIDCuongDo',$lstCuongDo , $toolcal->iIDCuongDo,'id="iIDCuongDo" name="iIDCuongDo" class="form-control" ');?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="panel panel-default col-md-6">
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <?php echo form_dropdown('iIDTocDoTangOrGiam',$iIDTocDoTangOrGiam , $toolcal->iIDTocDoTangOrGiam,'id="iIDTocDoTangOrGiam" name="iIDTocDoTangOrGiam" class="form-control" ');?>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="iIDMacro" class="col-sm-6 control-label">Macro</label>
                                                    <div class="col-sm-6">
                                                        <?php echo form_dropdown('iIDMacro',$iIDMacro , $toolcal->iIDMacro,'id="iIDMacro" name="iIDMacro" class="form-control" ');?>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-6 control-label">Số bữa ăn trong ngày</label>
                                                    <div class="col-sm-6">
                                                        <?php echo form_dropdown('iSoBuaAnNgay',$iSoBuaAnNgay , $toolcal->iSoBuaAnNgay,'id="iSoBuaAnNgay" name="iSoBuaAnNgay" class="form-control" ');?>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="accordion" class="panel-group col-sm-12" style="width: 103%; margin: -10px 0 0px -14px;">
                                            <div class="panel panel-default">
                                                ...
                                                <h4 class="panel-title">
                                                        <?php echo form_button(array('type' => 'submit', 'class' => 'btn btn-primary btn-flat', 'content' => 'CẬP NHẬT THÔNG TIN')); ?>
                                                        
                                                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" style="margin-left: 20px;">
...
<script>
    var fTotalCalori=0;
    var arrToolcalDetails = <?php echo json_encode($toolcaldetails) ?>;
    ...
    $(document).ready(function(){
        ...
        viewDataToolcalDetails();
        selectGioAn(1);
        function viewDataToolcalDetails(){
            if(arrToolcalDetails.length>0){
                let htmlData="";
                arrToolcalDetails.forEach(function(record) {
                    htmlData="";
                    selectGioAn(record.iIDGioAn);
                    htmlData+="<tr id='"+record.iIDThucAn+"'>";
                    htmlData+='<td style="display: none">'+record.iIDThucAn+'</td>';
                    htmlData+='<td><input type="text" id="'+sGioAn +'_' + record.iIDThucAn +'" id="'+sGioAn +'_' + record.iIDThucAn +' " size="4" value="'+record.sThoiGian+'" onchange="ChangeThoiGian();" ></td>';
                    htmlData+="<td>"+record.sTenThucAn+"</td>";
                    htmlData+="<td>"+record.sSLplusDVT+"</td>";
                    htmlData+="<td class='col-number'>"+(Math.round((record.fCalori) * 100) / 100)+"</td>";
                    htmlData+="<td class='col-number'>"+(Math.round((record.fDam) * 100) / 100)+"</td>";
                    htmlData+="<td class='col-number'>"+(Math.round((record.fBeo) * 100) / 100)+"</td>";
                    htmlData+="<td class='col-number'>"+(Math.round((record.fBotOrDuong) * 100) / 100)+"</td>";
                    htmlData+="<td class='col-number'>"+(Math.round((record.fXo) * 100) / 100)+"</td>";
                    htmlData+="<td data-id='"+record.iIDThucAn+"' ><a class='remove-item' onclick='removeItem("+record.iIDThucAn+");'>Remove</a></td>";
                    htmlData+="</tr>";
                    fTotalCalori += onConvertObjToFloat(record.fCalori);
                    $('#table'+sGioAn).append(htmlData);
                });

                //Set Data To Hidden Field
                let iSoBuaAnTrongNgay=onConvertObjToInt($("#iSoBuaAnNgay").val());
                for(i=1+1;i<=iSoBuaAnTrongNgay;i++){
                    SetDataToHiddenField('Bua'+i);
                }
