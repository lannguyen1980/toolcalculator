...
class Public_Controller extends MY_Controller
{
	public function __construct()
	{
        ...
        $this->load->model('admin/core_model');
        $this->load->helper('menu');
        $this->lang->load(array('public/main_header', 'public/main_sidebar', 'public/footer', 'public/actions'));
        ...
        $this->data['title_mini']  = $this->config->item('title_mini');
        $this->data['admin_prefs'] = $this->prefs_model->admin_prefs();
        $this->data['user_login']  = 1;//$this->prefs_model->user_info_login($this->ion_auth->user()->row()->id);
