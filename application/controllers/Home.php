...
class Home extends Public_Controller {
	...
	{
		// var_dump($_SESSION['$session_data']);
		// if($this->session->userdata('email')==null || $this->session->userdata('email')==''){
		if(!isset($_SESSION['email'])){
			redirect('user_authentication', 'refresh');
			//var_dump $this->session->userdata;
		}else{
			$toolcal = $this->Toolcals_model->geToolcalByEmail($_SESSION['email'])->row();
			if(isset($toolcal) && $toolcal!=null){
				redirect('home/edit/'.$toolcal->iIDCheDoAn, 'refresh');
			}else{
        ...
        // {
            ...
            // /* Load Template */
            // $this->template->public_render('public/home/index', $this->data);
        // }
    }
	...
	public function create()
	{
        ...
        /* Breadcrumbs */
        $this->breadcrumbs->unshift(2, 'Thêm mới', 'public/home/create');
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
		...
		if ($this->form_validation->run() == TRUE)
		{
			$additional_data = array(
				...
				'sCreateUser'      => $this->session->userdata('email')
			);
			...
			if ($new_toolcal_id)
			{
                ...
                redirect('home/edit/'.$new_toolcal_id, 'refresh');
			}
		}
		else
		{
            ...
            /* Load Template */
            $this->template->public_render('public/home/create', $this->data);
		}
	}
    ...
    //     else
    //     {
    //         $this->load->view('public/home/delete');
    //     }
	// }
   ...
   */
	...
	public function edit($id)
	{
        ...
        /* Breadcrumbs */
        $this->breadcrumbs->unshift(2, 'Sửa', 'public/home/edit');
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
		...
		if (isset($_POST) && ! empty($_POST))
		{
			if ($this->form_validation->run() == TRUE)
			{
				$additional_data = array(
					...
					'iSoNgayDuKien'      => $this->input->post('iSoNgayDuKien'),
					'dCreateDate'      => date('Y-m-d H:i:s'),
					'sUpdateUser'      => $this->session->userdata('email')
				);
				$additional_data_details = array(
					'hideBua1'      => $this->input->post('hideBua1'),
					'hideBua2'      => $this->input->post('hideBua2'),
	...
	// $this->data['hideBua1'] = array(
        ...
        /* Load Template */
        $this->template->public_render('public/home/edit', $this->data);
	}
}
